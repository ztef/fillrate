...
=======
                <span style='color:#fff600;font-size:${15*escalaTextos}px;'>Cumplimiento: </span> <span style='color:#ffffff'>${abastoPer} <span style='color:#ffffff;font-size:${12*escalaTextos}px;'> (Plan: ${formatNumber(entities[i].abasto.VolumenPlan/1000)}k , Real:${formatNumber(entities[i].abasto.VolumenReal/1000)}k)</span>
>>>>>>> 2efa622fca1c5f13d931cf5f3c8834f92c8a80f4
                </div>
                `
